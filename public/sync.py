...
def add_songs_to_apple_music(folder_path, album_name, album_artist):
    """Add downloaded mp3s straight to Apple Music library as an album"""
    ...
    for mp3_file in mp3_files:
        try:
            # Tag album name and artist metadata via ffmpeg
            ...
            # Add directly to library (no playlist)
